...
insert into public.products (name, price, category, description, image, rating, reviews) values
  ...
  ('Street Tag Vol.2',3.99, 'retro',      'Raw street tag aesthetic in classic black and white. Inspired by NYC subway art. Die-cut vinyl, ultra-durable.',                           'https://images.unsplash.com/photo-1600440699677-c6f39725adf6?w=400&h=400&fit=crop&auto=format', 5, 83),
  ...
  ('Graffiti Skull',  5.49, 'retro',      'Classic graffiti-style skull with drip effect. High contrast black and orange. Holographic outline.',                                        'https://images.unsplash.com/photo-1763888647755-5754915925ff?w=400&h=400&fit=crop&auto=format', 5, 101),
  ...
  ('Cosmic Drip',     5.99, 'retro',      'Cosmic abstract drip design with galaxy colors. Holographic foil finish. Statement piece for any surface.',                                 'https://images.unsplash.com/photo-1775665422545-42848b8536b9?w=400&h=400&fit=crop&auto=format', 5, 72);
