  ...
  return (
    <section id="hero" className="relative min-h-[100dvh] flex items-center overflow-hidden pt-14">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
        <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-8 lg:gap-12 py-10 md:py-20">
          {/* Content */}
          <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left max-w-xl gap-6 md:gap-8">
            {/* Logo + title overlay */}
          ...
          <div className="">
            <img
              src="/media/mascota/Mikan_Saludando.png"
              alt="Mikan saludando"
              className="h-48 sm:h-56 md:h-72 lg:h-auto w-auto"
            />
          </div>
        </div>
      </div>
